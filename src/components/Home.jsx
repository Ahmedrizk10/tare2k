...
const Home = () => {
  return (
    <div className='container mx-auto md:w-[1200px]'>
        <div className='container mx-auto h-screen mt-5 md:mt-13 '>
            <div className='grid grid-cols-1 md:grid-cols-2 items-center gap-10'>
                <div className='HomeText md:text-right text-center gap-y-2'>
                    ...
                    <button className="bg-transparent border border-[#11baf0]  px-5 py-3 rounded-xl hover:shadow-[0_0_50px_#11b8f0a2] transition-all duration-500">
                        تسجيل الدخول
                    </button>
                    </div>
                </div>
