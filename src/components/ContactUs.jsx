  ...
  <div className="grid md:grid-cols-2 gap-10 w-full max-w-6xl bg-white/2 backdrop-blur-xl p-10 rounded-2xl shadow-2xl">
    ...
    <div>
      ...
      <form className="flex flex-col gap-4">
        <input type="text" placeholder="اسمك "
          className="p-4 rounded-xl bg-[#464e6e36] text-black dark:text-white outline-none border-none focus:outline-[#070B1D] focus:border-[#11BAF0] " />
        <input type="email" placeholder="بريدك الالكتروي "
          className="p-4 rounded-xl bg-[#464e6e36] text-black dark:text-white outline-none border-none focus:outline-[#070B1D] focus:border-[#11BAF0] " />
        <input type="text" placeholder="الموضوع"
          className="p-4 rounded-xl bg-[#464e6e36] text-black dark:text-white outline-none border-none focus:outline-[#070B1D] focus:border-[#11BAF0] " />
        <textarea placeholder="رسالتك ..." rows="5"
          className="p-4 rounded-xl bg-[#464e6e36] text-black dark:text-white outline-none border-none focus:outline-[#070B1D] focus:border-[#11BAF0] "></textarea>
        <button className="mt-4 py-3 bg-[#11BAF0] font-bold text-lg rounded-lg shadow-lg hover:bg-[#11BAF0] hover:shadow-[0_0_50px_#11b8f0a2] transition-all duration-500">
          ارسال
        </button>
      </form>
    </div>
    ...
    <div className="flex flex-col gap-6 justify-center">
      ...
      <div className="flex items-center gap-4 mt-4">
        <a href="https://www.facebook.com/" className='text-2xl dark:text-[#a1a7be] text-[#070B1D]'><FaFacebookF /></a> 
        <a href="https://www.linkedin.com/" className='text-2xl dark:text-[#a1a7be] text-[#070B1D]'><FaLinkedinIn /></a> 
        <a href="https://www.instagram.com/" className='text-2xl dark:text-[#a1a7be] text-[#070B1D]'><FaInstagram /></a> 
        <a href="https://x.com/" className='text-2xl dark:text-[#a1a7be] text-[#070B1D]'><FaTwitter /></a>
      </div>
