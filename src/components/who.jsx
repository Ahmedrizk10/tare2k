        ...
        <div className="team mx-auto max-w-6xl text-center py-20 px-6">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            {team.map((member, index) => (
              <div
                key={index}
                className="bg-[#111425] rounded-2xl shadow-lg p-6 hover:-translate-y-2 hover:shadow-cyan-900/20 transition-all duration-300 relative overflow-hidden team-member-card"
              >
